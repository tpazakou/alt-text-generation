...
## Data
Contains the JSONL file with prompts and preference data, already split into sections. It is a combination of the **Concadia dataset** [1] and the **AD2AT-MD dataset** [2].  
